"""
Django settings for wheel_47096 project.
...
WSGI_APPLICATION = 'wheel_47096.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wheel_47096 API",
    "DESCRIPTION": "API documentation for wheel_47096 App",
    "VERSION": "v1",
}
